...
const CheckbalanceBscscan = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const abiToken = token == '0x55d398326f99059ff775485246999027b3197955' ? abiUSDT : token == '0x78ac6d3bc040edA72A5AfBB52837413A1Bc5bA1a' ? abiPBC : token == '0x78ac6d3bc040edA72A5AfBB52837413A1Bc5bA1a'
            ...
            <form className=' items-center p-16 pt-4 pb-0 flex justify-start flex-col w-full px-48' onSubmit={handleSubmit}>
                ...
                <div className='my-8 grid grid-cols-3 items-center w-full'>
                    ...
                    <select className=' p-2 border-4 rounded-[15px]' name='token' required>
                        ...
                        <option value="0x78ac6d3bc040edA72A5AfBB52837413A1Bc5bA1a">PBC</option>
                    </select>
                </div>
                <div className='my-8 grid grid-cols-3 items-center w-full'>
